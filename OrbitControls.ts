...
// import * as ZingTouch from "node_modules/zingtouch/dist/zingtouch.js";
...
export class OrbitControls extends THREE.EventDispatcher {
	...
	// activeRegion: ZingTouch.Region;

	constructor(object, domElement, customMouseDown) {
		super();
		this.customMouseDown = customMouseDown;
		this.object = object;
		this.domElement = (domElement !== undefined) ? domElement : document;
		// this.activeRegion = new ZingTouch.Region(this.domElement, false, true);
